				...
				<view @tap="onClickLeft" class="uni-navbar__header-btns uni-navbar__header-btns-left"
					...
					<slot name="left">
						<view class="uni-navbar__content_view" v-if="leftIcon.length > 0">
							<uni-icons v-if="!iconFlag" :color="themeColor" :type="leftIcon" size="20" />
							<i v-else :class="'iconfont ' + leftIcon"  :style="'font-size:' + iconSize +';color:'+themeColor"></i></view>
				...
				<view @click="onClickRight" class="uni-navbar__header-btns uni-navbar__header-btns-right"
					...
					<slot name="right">
						<view v-if="rightIcon.length">
							<uni-icons v-if="!iconFlag" :color="themeColor" :type="rightIcon" size="22" />
							<i v-else :class="'iconfont ' + rightIcon"  :style="'font-size:' + iconSize +';color:'+themeColor"></i>
						</view>
