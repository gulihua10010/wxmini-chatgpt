				...
				<slot name="header">
					<view class="uni-list-item__header">
						...
						<view v-else-if="showExtraIcon" class="uni-list-item__icon">
							<uni-icons v-if="!extraIcon.iconFlag" :customPrefix="extraIcon.customPrefix" :color="extraIcon.color" :size="extraIcon.size" :type="extraIcon.type" />
							<i v-else  :class="'iconfont '+ extraIcon.type" :style="'font-size: ' + extraIcon.size +';color:'+extraIcon.color"></i>
						</view>
					</view>
				</slot>
				<slot name="body">
